...
public class RabbitProducer {
    ...
    public void sendDirect2(Object message) {
        rabbitTemplate.convertAndSend(RabbitDefine.DIRECT_QUEUE2, message, this.getCorrelationData());
    }
    /**
     * 分裂模式发送消息
     *
    ...
    public void sendFanout(Object message) {
        message = message + "";rabbitTemplate.convertAndSend(RabbitDefine.FANOUT_EXCHANGE, "123", message);
    }
     ...
     */
    public void sendTopic(Object message, String routingKey) {message = message + "";
     ...
     * @param delay   延迟时间
     */
    public void sendDelay(String message, int delay) {message = message + "";
     ...
     * 发送临时消息
     */
    public void sendAndExpire(Object message) {message = message + "";
